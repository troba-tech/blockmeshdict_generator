...
from blockmeshdict_generator.classes.block import Block
...
class FixturedTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.block_1.set_boundary('bottom', 'inlet')
        self.block_1.set_boundary('top', 'outlet')
        self.block_1.set_boundary(['left', 'right', 'front', 'back'], 'walls')
